...
(function () {
    ...
    function clickConfirmButtonAfterCheckboxes() {
        const confirmButton = document.querySelector('.MuiButtonBase-root.MuiButton-root.MuiButton-contained.MuiButton-containedPrimary.MuiButton-sizeSmall.MuiButton-containedSizeSmall.MuiButton-colorPrimary.css-1f3rdy8');
        if (confirmButton) {
            confirmButton.click();
        }
    }
